<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="WSWApp.MainPages.ContactUs" %>
          ...
          <div class="col-12 col-xl-11">
            ...
            <div class="d-flex mb-5">
              ...
              <div>
                ...
                <address class="mb-0 text-secondary">1st floor, SHIBA Group Building, Plot No. 32, Block No.1, Survey No. 41(P), Opp: UR Life Studio, Kavuri Hills, Madhapur, Hyderabad - 500033</address>
              </div>
            </div>
            <div class="row mb-5">
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-5 mb-sm-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="tel:+919999999999">(+91) 9999999999</a>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="mailto:sales@squaresandyards.com">sales@squaresandyards.com</a>
                    </p>
                  </div>
                </div>
              </div>
