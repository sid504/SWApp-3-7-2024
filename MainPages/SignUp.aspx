<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="WSWApp.MainPages.SignUp" %>
        ...
        <div class="container">
            <div class="row gy-4 align-items-center">
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="d-flex justify-content-center bg-success-subtle">
                        <div class="col-12 col-xl-9">
                            ...
                            <p class="lead mb-5">We build TRUST.</p>
                            <div class="text-endx">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                                        <p class="m-0 text-secondary text-center">Already have an account? <a href="Login.aspx" class="link-success text-decoration-none">Sign in</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
