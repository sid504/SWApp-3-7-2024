<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerPanel/CustomerMaster.Master" AutoEventWireup="true" CodeBehind="CustomerProfile.aspx.cs" Inherits="WSWApp.CustomerPanel.CustomerProfile" %>
                    ...
                    <div class="row gy-4">
                        <div class="col-12">
                            <div class="card widget-card border-light shadow-sm">
                                <div class="card-header text-bg-primary">Welcome, Jahnavi</div>
                                <div class="card-body">
                                    <div class="text-center mb-3">
                                        <img src="../Images/jahnavi.jpeg" class="img-fluid rounded-circle" alt="Luna John">
                                    </div>
                                    <h5 class="text-center mb-1">Jahnavi</h5>
                                    <ul class="list-group list-group-flush mb-4">                                        
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <h6 class="m-0">Lock-In(Period)</h6>
                                            <span>1 Year</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <h6 class="m-0">Invested</h6>
                                            <span>RS.7,854/-</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-grid m-0">
                                        <button class="btn btn-outline-primary" type="button">New Purchase</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="card widget-card border-light shadow-sm">
                                <div class="card-header text-bg-primary">Account Verification Details</div>
                                <div class="card-body">
                                    <asp:Button runat="server" ID="btnKYC" Text="KYC verification" CssClass="btn btn-outline-primary" />                                 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="tab-content pt-4" id="profileTabContent">
                                <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel" aria-labelledby="overview-tab" tabindex="0">
                                    ...
                                    <p class="lead mb-3">Jahnavi is a seasoned and results-driven Project Manager who brings experience and expertise to project management. With a proven track record of successfully delivering complex projects on time and within budget, Jahnavi is the go-to professional for organizations seeking efficient and effective project leadership.</p>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                            <div class="p-2">India</div>
                                        </div>
                                        <div class="col-5 col-md-3 bg-light border-bottom border-white border-3">
                                            <div class="p-2">Company</div>
                                        </div>
                                        <div class="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                            <div class="p-2">Innojc</div>
                                        </div>
                                        <div class="col-5 col-md-3 bg-light border-bottom border-white border-3">
                                            <div class="p-2">Phone</div>
                                        </div>
                                        <div class="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                            <div class="p-2">+919999999999</div>
                                        </div>
                                        <div class="col-5 col-md-3 bg-light border-bottom border-white border-3">
                                            <div class="p-2">Email</div>
                                        </div>
                                        <div class="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                            <div class="p-2">jahnavi@innojc.com</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form action="#!" class="row gy-3 gy-xxl-4">
                                        <div class="col-12">
                                            <div class="row gy-2">
                                                ...
                                                <div class="col-12">
                                                    <img src="../Images/jahnavi.jpeg" class="img-fluid" style="width:50;height:50" alt="Luna John">
                                                </div>
                                                <div class="col-12">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputCompany" value="">
                                        </div>
                                        <div class="col-12 col-md-6">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="inputAbout">Jahnavi is a seasoned and results-driven Project Manager who brings experience and expertise to project management. With a proven track record of successfully delivering complex projects on time and within budget, Jahnavi is the go-to professional for organizations seeking efficient and effective project leadership.</textarea>
                                        </div>
                                        <div class="col-12">
